# Auto-generated from frontend/js/variables.js
# This mirrors the JS config for the backend
...
BISNIS_CONFIG = {
  ...
  "minimarket": {
    ...
    "kelompok": [
      {"nama": "Demand", "variabel": [
        ...
        {"id": "demand_kantor", "label": "Jarak ke Kantor", "unit": "meter", "min": 0, "max": 3000, "default": 500, "desc": "Area kerja banyak karyawan"}
      ]},
      {"nama": "Kompetitor", "variabel": [
        {"id": "komp_minimarket", "label": "Jumlah Minimarket di Radius 1km", "unit": "unit", "min": 0, "max": 15, "default": 3, "desc": "Hindari area jenuh"},
        {"id": "komp_pasar", "label": "Jarak ke Pasar Tradisional", "unit": "meter", "min": 0, "max": 3000, "default": 1000, "desc": "Bisa jadi kompetitor"}
      ]},
      {"nama": "Aksesibilitas", "variabel": [
        {"id": "akses_jalan", "label": "Jarak dari Jalan Utama", "unit": "meter", "min": 0, "max": 200, "default": 30, "desc": "Visibility penting"},
        {"id": "akses_parkir", "label": "Ketersediaan Parkir", "unit": "%", "min": 0, "max": 100, "default": 70, "desc": "Area parkir memadai"}
      ]},
      {"nama": "Regulasi", "variabel": [
        {"id": "reg_kdb", "label": "KDB Maksimal", "unit": "%", "min": 0, "max": 100, "default": 60, "desc": "Koefisien Dasar Bangunan"}
      ]}
    ]
  },
  ...
  "klinik": {
    ...
    "kelompok": [
      {"nama": "Demand", "variabel": [
        ...
        {"id": "demand_rs", "label": "Jarak ke Rumah Sakit", "unit": "meter", "min": 0, "max": 10000, "default": 3000, "desc": "Suplemen RS"}
      ]},
      {"nama": "Kompetitor", "variabel": [
  ...
  "kantor": {
    ...
    "kelompok": [
      {"nama": "Demand", "variabel": [
        {"id": "demand_bisnis", "label": "Kepadatan Bisnis", "unit": "%", "min": 0, "max": 100, "default": 60, "desc": "Pusat kegiatan bisnis"},
